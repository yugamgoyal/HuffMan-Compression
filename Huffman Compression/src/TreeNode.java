...
public class TreeNode implements Comparable<TreeNode> {
	...
	/*
	 * The value stored in this node. A number read from a file. No matter the
	 * file type we read in bits and treat the data as an int.
	 */
	private int value;

	/*
	 * The frequency of the value for leaf nodes or the sum of the frequency of
	 * the children for internal nodes.
	 */
	 ...
	 * 
	 * @param value
	 *            is the value stored in the node (e.g., value from original
	 *            file)
	 * @param freq
	 *            is number of times value occurred (e.g., count of #
	 *            occurrences)
	 */
	 ...
	 * The new node's frequency will be the sum of the frequencies of
	 * leftSubtree and rightSubtree.
	 * 
	 * @param value
	 *            the stored as value of node
	 * @param leftSubtree
	 *            is left subtree
	 * @param rightSubtree
	 *            is right subtree
	...
	public TreeNode(TreeNode leftSubtree, int value, TreeNode rightSubtree) {
		if (leftSubtree == null || rightSubtree == null)
			throw new IllegalArgumentException(
					"child node references cannot be null");
		this.value = value;
		left = leftSubtree;
		right = rightSubtree;
	 ...
	 * 
	 * @return value < 0 if this < rhs, value > 0 if this > rhs, and 0 if this
	 *         == rhs
	 */
	 ...
	 * 
	 * @return A String version of this node including the frequency (weight)
	 *         and value.
	 */
	public String toString() {
		// consider values as characters for readability
		return "(" + frequency + ", " + (char) value + " as char, " + value
				+ " value as int)";
	}
	 ...
	 * 
	 * @return the frequency of this node. For internal nods the value should be
	 ...
	 * 
	 * @param newLeft
	 *            The new left child for this TreeNode.
	 */
	...
	public void printTree(TreeNode val) {
		printTree(val, "");
	}
